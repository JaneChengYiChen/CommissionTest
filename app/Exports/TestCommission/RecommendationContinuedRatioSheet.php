...
class RecommendationContinuedRatioSheet implements WithTitle, WithHeadings, ShouldAutoSize, FromCollection, WithMapping
{
    ...
    public function collection()
    {
        ...
        $data = $QueryCollection->recommendationContinuedRatio($this->manCode);
